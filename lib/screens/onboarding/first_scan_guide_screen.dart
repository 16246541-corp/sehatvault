                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTip(
                              Icons.lightbulb_outline, 'Ensure good lighting'),
                          _buildTip(Icons.straighten_rounded,
                              'Keep the document flat'),
                          _buildTip(Icons.vibration_rounded,
                              'Hold steady for better OCR'),
                        ],
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          TextButton(
            onPressed: _skip,
            child: const Text('I\'ll scan later',
