...
class MedicationExtractor extends BaseExtractor {
  ...
  List<String> get verbs => [
    "take", "start", "stop", "increase", "decrease", "refill", 
    "continue", "discontinue", "adjust", "switch", "taper"
  ];
  ...
  String? extractObject(String sentence, String verb, int verbIndex) {
    ...
    if (medication != null) {
      ...
      final dosagePattern = RegExp(r'\b\d+(\.\d+)?\s*(mg|g|ml|mcg|oz|tablet|pill|capsule|drop)s?\b', caseSensitive: false);
